        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-md-6 col-lg-4">
                <div class="blog grid-blog">
                    ...
                    <a href="{{ url('admin/blog/'.$post->id.'/edit') }}"><img class="img-fluid" src="/storage/uploads/{{$post->blog_image}}" alt=""></a>
                    </div>
                    ...
                    <p style="word-break: break-word"><?php echo substr($post->blog_description,0,50) ?>...</p>
                        ...
                        <div class="blog-info clearfix">
                            <div class="post-left">
                                ...
                                <a data-toggle="modal" class="dropdown-item" data-target="#delete_department" href="{{ url('admin/blog/'.$post->id.'/') }}"
                                    onclick="event.preventDefault();"><i class="fa fa-trash-o m-r-5"></i>
                                    {{ __('delete') }}
                                </a>

                                <form id="delete-form" action="{{ url('admin/blog/'.$post->id.'/') }}" method="POST" style="display: none;">
                                    @csrf
                                    @method('DELETE')
                                </form>
                            </div>
